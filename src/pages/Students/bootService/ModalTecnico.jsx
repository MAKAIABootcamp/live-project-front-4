    ...
    isModalOpen && (
      <ModalContainer>
        <ModalContent>
          ...
          <BodyModal>
            {/*Contenindo modela */}
            <p>Recuerda que este espacio es para ayudarte a resolver preguntas o necesidades técnicas en el marco de tu proceso formativo</p>
            <Formik
            ...
            >
              {({ errors, touched }) => (
                <Form>
                  ...
                  <ol>
                    <ListItem>
                      <label htmlFor="descripcion">1. Déjanos aquí tus preguntas técnicas o la descripción del tema que quieres resolver. <span>*</span></label>
